...
const ActivationTimeline = () => {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute -bottom-[21vh] md:-bottom-[30vh] lg:-bottom-[35vh] 2xl:-bottom-[35vh] left-1/2 -translate-x-1/2 flex items-center justify-center">
        <div
          ref={circleRef}
