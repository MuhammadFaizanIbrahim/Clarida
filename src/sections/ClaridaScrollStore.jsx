  ...
  return (
    <section className="relative h-screen flex items-end justify-between text-white overflow-hidden">
      ...
      >
        {/* Left Side */}
        <motion.div
          className="w-full flex flex-col gap-3 md:gap-6 items-center md:items-start"
          variants={containerVariants}
        >
          <motion.h1 className="h2-text text-left" variants={itemVariants}>
            Awaken Your <span className="h2-text-bold">Vision</span>
            <br /> Reserve <span className="h2-text-bold">Early Access</span>
          </motion.h1>
        </motion.div>
        ...
        >
          <motion.p
            className="hero-paragraph-normal w-[350px] md:w-[400px] lg:w-[780px] text-center md:text-left"
            variants={itemVariants}
          >
            Clarida is built on 100 million years of marine wisdom. Now it’s almost ready.
          </motion.p>
          <motion.div
            variants={itemVariants}
...
export default ClaridaScrollStore;
