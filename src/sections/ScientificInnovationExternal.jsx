// src/sections/ScientificInnovationExternal.jsx
...
const ScientificInnovationExternal = ({ active = true }) => {
  ...
  return (
    ...
    >
      ...
      {/* 🔊 SECTION AUDIO */}
      <audio ref={audioRef} src="/audios/scientific.mp3" preload="auto" loop />
      ...
      <EntranceAnimation
        ...
        style={{
          background: `linear-gradient(180deg, rgba(0, 0, 0, 0.40) 0%, rgba(0, 0, 0, 0.00) 25%),
...
export default ScientificInnovationExternal;
